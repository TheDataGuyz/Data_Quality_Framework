...
VALUES (
    ...
    'Suppliers',
    'Region,PostalCode',
    'SupplierID', -- SupplierID is the primary key
	'N',
    'DQ1',
    'CATEGORY1',
    0.1, -- Set threshold to 0
    'High',
    'Region and PostalCode should not be null',
    'Region IS NULL OR PostalCode IS NULL', -- Validation script to check if ShipRegion is not null
    '1' -- Active flag
);