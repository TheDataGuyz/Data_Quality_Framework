CREATE TABLE PRODUCT.SECURITY.DQ_RULE (
    ...
    UPDATED_TIMESTAMP DATETIME2(3) DEFAULT GETDATE() ON UPDATE CURRENT_TIMESTAMP,
    --need to handle this using triggers in SQL Server
...
BEGIN
    ...
    BEGIN
        ...
        INNER JOIN inserted ON DQ_RULE.DQ_RULE_ID = inserted.DQ_RULE_ID;
    END;
END;
